...
using System.Text;
using EventInfo = IgniteX.PlcLib.PlcModel.EventInfo;

namespace IgniteX.PlcLib.Utils
{
            ...
            foreach (var pi in pis)
            {
                ...
                if (customAttributes.Length > 0)
                {
                    ...
                    if (pi.PropertyType.IsArray)
                    {
                        ...
                        string ret = typeof(SiemensRefelectionUtil).RefelectionCallStaticMethod("CreateArraryObject", ref ret_obj, ref ret_value, pi.PropertyType.GetElementType());
                    ...
                    else
                    {
                        ...
                        typeof(SiemensRefelectionUtil).RefelectionCallStaticMethod("CreateObject1", ref ret_obj, ref ret_value, pi.PropertyType.GetTypeInfo());
            ...
            foreach (var pi in pis)
            {
                ...
                if (customAttributes.Length > 0)
                {
                    ...
                    if (pi.PropertyType.IsArray)
                    {
                        ...
                        string ret = typeof(SiemensRefelectionUtil).RefelectionCallStaticMethod("CreateArraryObjectL", ref ret_obj, ref ret_value, pi.PropertyType.GetElementType());
                    ...
                    else
                    {
                        ...
                        typeof(SiemensRefelectionUtil).RefelectionCallStaticMethod("CreateObjectL", ref ret_obj, ref ret_value, pi.PropertyType.GetTypeInfo());
            ...
            foreach (var pi in pis)
            {
                ...
                if (customAttributes.Length > 0)
                {
                    ...
                    else
                    {
                        ...
                        typeof(SiemensRefelectionUtil).RefelectionCallStaticMethod("CreateObject", ref ret_obj, ref ret_value, pi.PropertyType.GetTypeInfo());
                ...
                if (customAttributes1.Length > 0)
                {
                    ...
                    {
                        //beckhoff 内存寻址 float 必须4的整数倍
                        int a = startIndex % 4 != 0 ? 4 - startIndex % 4 : 0;
                        //  idx += a;
                        // startIndex += a;
